...
✅ App #1 (RageBite) — package verification BYPASS
"""
...
# ✅ App #1 (RageBite) — package verification BYPASS
# Jo bhi package aaye (com.tencent.ig, com.dts.freefireth, etc.),
# usse com.ragebite.app maan lo — sirf App #1 ki keys ke liye
...
def normalize_package(pkg, key=None):
    """
    ✅ App #1 (RageBite) ke liye package bypass.
    
    - Agar key App #1 ki hai (com.ragebite.app) → hamesha com.ragebite.app return karo
      (chahe client com.tencent.ig, com.dts.freefireth, ya kuch bhi bheje)
    - Agar key App #2/#3/#4 ki hai → client ka pkg as-is return karo (strict check)
    - Agar key nahi mili / invalid → pkg as-is return karo
    """
    if key:
...
def api_verify():
    ...
    # ✅ App #1 bypass — key ki app_id dekh ke pkg normalize karo
...
def api_dd():
    ...
    # ✅ App #1 bypass — ye line hi asli fix hai
    pkg = normalize_package(pkg, key)
...
def main():
    ...
    print(f"✅ App #1 bypass: {BYPASS_PACKAGES}")
    print("=" * 60)
    print("✅ Running...")
    print("=" * 60)
